...
| JDK | `17` |
| Coordinates | `io.github.easy4j:pf4j-spring-boot-starter:1.0.6.RELEASE` |
| Config Prefix | `pf4j` |
...
| `PluginStateListener` bean | ✅ Stable | Auto-registered via Pf4jAutoConfiguration, Pf4jUpdateAutoConfiguration |
