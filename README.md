...
**Spring Boot Starter for pf4j3**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/pf4j3-spring-boot-starter)](https://github.com/easy-4-java/pf4j3-spring-boot-starter)
...
> **Artifact ID**：`pf4j3-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**pf4j3-spring-boot-starter** is a Spring Boot starter that integrates **pf4j3** for applications using pf4j3. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume pf4j3 capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using pf4j3 |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for pf4j3 |
| JDK | `17` |
| Coordinates | `io.github.easy4j:pf4j3-spring-boot-starter:2.0.0.RELEASE` |
| Config Prefix | `pf4j3` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers pf4j3 beans automatically |
| Property Binding | ✅ Stable | Binds `pf4j3.*` to `Pf4jMavenProperties` |
| `Pf4jDynamicControllerRegistry` bean | ✅ Stable | Auto-registered via Pf4jAutoConfiguration, Pf4jMavenAutoConfiguration, Pf4jUpdateAutoConfiguration |
...
| `PluginStateListener` | classpath + property | not created |
...
|---|---|---|:---:|---|:---:|
| `pf4j3.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl pf4j3-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `pf4j3.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/pf4j3-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/pf4j3-spring-boot-starter)
