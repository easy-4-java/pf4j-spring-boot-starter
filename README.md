...
| JDK | `17` |
| Coordinates | `io.github.easy4j:pf4j-spring-boot-starter:1.0.4.RELEASE` |
| Config Prefix | `pf4j` |
...
| `Pf4jDynamicControllerRegistry` bean | ✅ Stable | Auto-registered via Pf4jAutoConfiguration |
