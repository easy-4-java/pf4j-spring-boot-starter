...
> **Current Version**：`1.0.8-SNAPSHOT`<br>
> **JDK Baseline**：`17`<br>
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:pf4j-spring-boot-starter:1.0.8-SNAPSHOT` |
| Config Prefix | `pf4j` |
...
| Property Binding | ✅ Stable | Binds `pf4j.*` to `Pf4jMavenProperties` |
| `PluginStateListener` bean | ✅ Stable | Auto-registered via Pf4jAutoConfiguration, Pf4jMavenAutoConfiguration, Pf4jUpdateAutoConfiguration |
...
| `ExtendedExtensionsInjector` | classpath + property | not created |
