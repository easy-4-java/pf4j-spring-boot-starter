...
| JDK | `17` |
| 坐标 | `io.github.easy4j:pf4j-spring-boot-starter:1.0.8-SNAPSHOT` |
| 配置前缀 | `pf4j` |
...
| 属性绑定 | ✅ 稳定 | 绑定 `pf4j.*` 到 `Pf4jMavenProperties` |
| `PluginStateListener` Bean | ✅ 稳定 | 通过 Pf4jAutoConfiguration, Pf4jMavenAutoConfiguration, Pf4jUpdateAutoConfiguration 自动注册 |
...
| `ExtendedExtensionsInjector` | classpath + property | 不创建 |
